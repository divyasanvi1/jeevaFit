...
const LoginPage = () => {
  ...
  return (
    ...
    <div className='max-w-screen-lg mx-auto h-screen flex flex-wrap items-center justify-center'>
      <div className='w-full m-4 sm:mx-32 flex flex-wrap flex-col sm:flex-row bg-[#F8F7FF] rounded-lg 023E8Ashadow-sm shadow-[#F8F7FF] backdrop-blur-[4px] border border-[#023E8A]/20'>
      <div className='md:hidden w-full  sm:w-2/5 flex flex-col bg-[#FF5400] items-center justify-center rounded-lg p-8'>
      ...
      <div className='w-full flex flex-wrap items-center justify-between mt-12 mx-2'>
        ...
        By <span className='font-bold text-[#FF6D00]/70 underline'>continuing</span>, I agree to JeevaFits’s <span className='font-bold text-[#FF6D00]/70 underline'>Privacy Policy</span> and <span className='font-bold text-[#FF6D00]/70 underline'>Terms of Use</span>. 
        </p>
        </div>
        </div>
        <div className='hidden md:block w-full  sm:w-2/5 flex flex-col bg-[#FF5400] items-center justify-center rounded-lg p-8'>
        <div className='w-full h-full flex flex-col items-center justify-center'>
        <h1 className='text-[24px] sm:text-[28px] md:text-[32px] font-sans-serif text-white font-bold -tracking-tight leading-[135%] mb-4'>
        Welcome Back!
        </h1>
